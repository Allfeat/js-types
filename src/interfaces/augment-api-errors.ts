...
declare module '@polkadot/api-base/types/errors' {
  interface AugmentedErrors<ApiType extends ApiTypes> {
    artists: {
       ...
       **/
      IsVerified: AugmentedError<ApiType>;
      /**
       * The artist name is already attributed to a verified artist.
       **/
      NameUnavailable: AugmentedError<ApiType>;
      /**
       ...
       **/
      NotUniqueAsset: AugmentedError<ApiType>;
      /**
       * A genre appear multiple time in the artist data.
       **/
      NotUniqueGenre: AugmentedError<ApiType>;
      /**
       * Unregister period isn't fully passed.
       **/
      PeriodNotPassed: AugmentedError<ApiType>;
      /**
       * Generic error
       **/
