...
import type { EthereumBlock, EthereumReceiptReceiptV3, EthereumTransactionTransactionV2, FpRpcTransactionStatus, FrameSupportDispatchPerDispatchClassWeight, FrameSystemAccountInfo, FrameSystemEventRecord, FrameSystemLastRuntimeUpgradeInfo, FrameSystemPhase, HarmonieRuntimeOpaqueSessionKeys, HarmonieRuntimeRuntimeHoldReason, PalletArtistsV2Artist, PalletBagsListListBag, PalletBagsListListNode, PalletBalancesAccountData, PalletBalancesBalanceLock, PalletBalancesIdAmount, PalletBalancesReserveData, PalletContractsStorageContractInfo, PalletContractsStorageDeletionQueueManager, PalletContractsWasmCodeInfo, PalletElectionProviderMultiPhasePhase, PalletElectionProviderMultiPhaseReadySolution, PalletElectionProviderMultiPhaseRoundSnapshot, PalletElectionProviderMultiPhaseSignedSignedSubmission, PalletElectionProviderMultiPhaseSolutionOrSnapshotSize, PalletEvmCodeMetadata, PalletGrandpaStoredPendingChange, PalletGrandpaStoredState, PalletIdentityRegistrarInfo, PalletIdentityRegistration, PalletImOnlineSr25519AppSr25519Public, PalletMultisigMultisig, PalletNominationPoolsBondedPoolInner, PalletNominationPoolsClaimPermission, PalletNominationPoolsPoolMember, PalletNominationPoolsRewardPool, PalletNominationPoolsSubPools, PalletPreimageRequestStatus, PalletProxyAnnouncement, PalletProxyProxyDefinition, PalletRecoveryActiveRecovery, PalletRecoveryRecoveryConfig, PalletSchedulerScheduled, PalletStakingActiveEraInfo, PalletStakingEraRewardPoints, PalletStakingExposure, PalletStakingForcing, PalletStakingNominations, PalletStakingRewardDestination, PalletStakingSlashingSlashingSpans, PalletStakingSlashingSpanRecord, PalletStakingStakingLedger, PalletStakingUnappliedSlash, PalletStakingValidatorPrefs, PalletStateTrieMigrationMigrationLimits, PalletStateTrieMigrationMigrationTask, PalletTransactionPaymentReleases, SpAuthorityDiscoveryAppPublic, SpConsensusBabeAppPublic, SpConsensusBabeBabeEpochConfiguration, SpConsensusBabeDigestsNextConfigDescriptor, SpConsensusBabeDigestsPreDigest, SpCoreCryptoKeyTypeId, SpNposElectionsElectionScore, SpRuntimeDigest, SpStakingOffenceOffenceDetails } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    artists: {
      artistNameOf: AugmentedQuery<ApiType, (arg: Bytes | string | Uint8Array) => Observable<Option<PalletArtistsV2Artist>>, [Bytes]> & QueryableStorageEntry<ApiType, [Bytes]>;
      artistOf: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<PalletArtistsV2Artist>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       * Generic query
       **/
    ...
    bagsList: {
       ...
       **/
      listNodes: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<PalletBagsListListNode>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    balances: {
       ...
       **/
      freezes: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Vec<PalletBalancesIdAmount>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       * Holds on account balances.
       **/
      holds: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Vec<{
    readonly id: HarmonieRuntimeRuntimeHoldReason;
    readonly amount: u128;
  } & Struct>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
    ...
    contracts: {
       ...
       **/
      contractInfoOf: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<PalletContractsStorageContractInfo>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
    ...
    identity: {
       ...
       **/
      identityOf: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<PalletIdentityRegistration>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       ...
       * TWOX-NOTE: OK ― `AccountId` is a secure hash.
       **/
      subsOf: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<ITuple<[u128, Vec<AccountId20>]>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       * The super-identity of an alternative "sub" identity together with its name, within that
       * context. If the account is not some other account's sub-identity, then just `None`.
       **/
      superOf: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<ITuple<[AccountId20, Data]>>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    imOnline: {
       ...
       **/
      authoredBlocks: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: AccountId20 | string | Uint8Array) => Observable<u32>, [u32, AccountId20]> & QueryableStorageEntry<ApiType, [u32, AccountId20]>;
      /**
    ...
    multisig: {
       ...
       **/
      multisigs: AugmentedQuery<ApiType, (arg1: AccountId20 | string | Uint8Array, arg2: U8aFixed | string | Uint8Array) => Observable<Option<PalletMultisigMultisig>>, [AccountId20, U8aFixed]> & QueryableStorageEntry<ApiType, [AccountId20, U8aFixed]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    nominationPools: {
       ...
       **/
      claimPermissions: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<PalletNominationPoolsClaimPermission>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       * Counter for the related counted storage map
       **/
       ...
       * TWOX-NOTE: SAFE since `AccountId` is a secure hash.
       **/
      poolMembers: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<PalletNominationPoolsPoolMember>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       ...
       **/
      reversePoolIdLookup: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<u32>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
    ...
    proxy: {
       ...
       **/
      announcements: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<ITuple<[Vec<PalletProxyAnnouncement>, u128]>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       * The set of account proxies. Maps the account which has delegated to the accounts
       * which are being delegated to, together with the amount held on deposit.
       **/
      proxies: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<ITuple<[Vec<PalletProxyProxyDefinition>, u128]>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    recovery: {
       ...
       **/
      activeRecoveries: AugmentedQuery<ApiType, (arg1: AccountId20 | string | Uint8Array, arg2: AccountId20 | string | Uint8Array) => Observable<Option<PalletRecoveryActiveRecovery>>, [AccountId20, AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20, AccountId20]>;
      /**
       * The list of allowed proxy accounts.
       * 
       * Map from the user who can access it to the recovered account.
       **/
      proxy: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<AccountId20>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       * The set of recoverable accounts and their recovery configuration.
       **/
      recoverable: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<PalletRecoveryRecoveryConfig>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<HarmonieRuntimeOpaqueSessionKeys>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       ...
       **/
      queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId20, HarmonieRuntimeOpaqueSessionKeys]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    staking: {
       ...
       * TWOX-NOTE: SAFE since `AccountId` is a secure hash.
       **/
      bonded: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<AccountId20>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       ...
       **/
      erasStakers: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: AccountId20 | string | Uint8Array) => Observable<PalletStakingExposure>, [u32, AccountId20]> & QueryableStorageEntry<ApiType, [u32, AccountId20]>;
      /**
       ...
       * If stakers hasn't been set or has been removed then empty exposure is returned.
       **/
      erasStakersClipped: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: AccountId20 | string | Uint8Array) => Observable<PalletStakingExposure>, [u32, AccountId20]> & QueryableStorageEntry<ApiType, [u32, AccountId20]>;
      /**
       ...
       * Is it removed after `HISTORY_DEPTH` eras.
       **/
      erasValidatorPrefs: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: AccountId20 | string | Uint8Array) => Observable<PalletStakingValidatorPrefs>, [u32, AccountId20]> & QueryableStorageEntry<ApiType, [u32, AccountId20]>;
      /**
       ...
       **/
      invulnerables: AugmentedQuery<ApiType, () => Observable<Vec<AccountId20>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Map from all (unlocked) "controller" accounts to the info regarding the staking.
       **/
      ledger: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<PalletStakingStakingLedger>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       ...
       * TWOX-NOTE: SAFE since `AccountId` is a secure hash.
       **/
      nominators: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<PalletStakingNominations>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       * All slashing events on nominators, mapped by era to the highest slash value of the era.
       **/
      nominatorSlashInEra: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: AccountId20 | string | Uint8Array) => Observable<Option<u128>>, [u32, AccountId20]> & QueryableStorageEntry<ApiType, [u32, AccountId20]>;
      /**
       ...
       * TWOX-NOTE: SAFE since `AccountId` is a secure hash.
       **/
      payee: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<PalletStakingRewardDestination>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       * Slashing spans for stash accounts.
       **/
      slashingSpans: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<PalletStakingSlashingSlashingSpans>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       ...
       **/
      spanSlash: AugmentedQuery<ApiType, (arg: ITuple<[AccountId20, u32]> | [AccountId20 | string | Uint8Array, u32 | AnyNumber | Uint8Array]) => Observable<PalletStakingSlashingSpanRecord>, [ITuple<[AccountId20, u32]>]> & QueryableStorageEntry<ApiType, [ITuple<[AccountId20, u32]>]>;
      /**
       ...
       * TWOX-NOTE: SAFE since `AccountId` is a secure hash.
       **/
      validators: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<PalletStakingValidatorPrefs>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       * All slashing events on validators, mapped by era to the highest slash proportion
       * and slash value of the era.
       **/
      validatorSlashInEra: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: AccountId20 | string | Uint8Array) => Observable<Option<ITuple<[Perbill, u128]>>>, [u32, AccountId20]> & QueryableStorageEntry<ApiType, [u32, AccountId20]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
